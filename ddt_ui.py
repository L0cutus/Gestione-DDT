...
# Form implementation generated from reading ui file 'ddt.ui'
#
# Created: Sat Jun 27 17:09:50 2009
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.dateEdit, 1, 1, 1, 3)
        self.label_5 = QtGui.QLabel(self.centralwidget)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 2, 0, 1, 1)
        self.ddtLineEdit = QtGui.QLineEdit(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ddtLineEdit.sizePolicy().hasHeightForWidth())
        self.ddtLineEdit.setSizePolicy(sizePolicy)
        self.ddtLineEdit.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.ddtLineEdit.setObjectName("ddtLineEdit")
        self.gridLayout.addWidget(self.ddtLineEdit, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.cliComboBox, 4, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.cauLineEdit, 5, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.noteLineEdit, 6, 1, 1, 5)
        ...
        spacerItem = QtGui.QSpacerItem(132, 33, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 7, 5, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(25, 33, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.gridLayout.addWidget(self.sTableView, 8, 0, 1, 8)
        ...
        spacerItem2 = QtGui.QSpacerItem(423, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem2, 9, 4, 1, 4)
        ...
        self.copiaIntCheckBox.setGeometry(QtCore.QRect(0, 20, 113, 21))
        ...
        self.copiaCliCheckBox.setGeometry(QtCore.QRect(0, 40, 113, 21))
        ...
        self.gridLayout.addWidget(self.groupBox, 1, 6, 4, 2)
        ...
        self.label_5.setBuddy(self.ddtLineEdit)
        ...
        MainWindow.setTabOrder(self.dateEdit, self.ddtLineEdit)
        MainWindow.setTabOrder(self.ddtLineEdit, self.cliComboBox)
        MainWindow.setTabOrder(self.cliComboBox, self.cauLineEdit)
        MainWindow.setTabOrder(self.cauLineEdit, self.noteLineEdit)
        MainWindow.setTabOrder(self.noteLineEdit, self.sTableView)
        MainWindow.setTabOrder(self.sTableView, self.addMPushButton)
        MainWindow.setTabOrder(self.addMPushButton, self.delMPushButton)
        MainWindow.setTabOrder(self.delMPushButton, self.firstMPushButton)
        MainWindow.setTabOrder(self.firstMPushButton, self.prevMPushButton)
        MainWindow.setTabOrder(self.prevMPushButton, self.nextMPushButton)
        MainWindow.setTabOrder(self.nextMPushButton, self.lastMPushButton)
        MainWindow.setTabOrder(self.lastMPushButton, self.printPushButton)
        MainWindow.setTabOrder(self.printPushButton, self.addSPushButton)
        MainWindow.setTabOrder(self.addSPushButton, self.delSPushButton)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Gestione Documenti di Trasporto", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_5.setText(QtGui.QApplication.translate("MainWindow", "N.Ddt:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate("MainWindow", "Stampa DDT", None, QtGui.QApplication.UnicodeUTF8))
